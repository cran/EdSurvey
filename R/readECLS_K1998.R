...
#'
#' @param path a character value to the full directory path(s) to the ECLS-K
...
#' @details Reads in the unzipped files downloaded from the ECLS-K 1998 longitudinal database(s) to an \code{edsurvey.data.frame}.  The ECLS-K 1998-1999 study consisted of
