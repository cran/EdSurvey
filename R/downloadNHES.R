...
#' @export
downloadNHES <- function(years=c(1991,1993,1995,1996,1999,
                                 2001,2003,2005,2007,2012,2016,2019)) {
                                        
  
  validYears <- c(1991,1993,1995,1996,1999,
                  2001,2003,2005,2007,2012,2016,2019)
  ...
  txt <- c()
  txt <- c(txt, paste0("Please manually download and extract the SPSS (*.sav) formatted NHES study data files from the NCES Online Codebook to a folder on your local system or network. ",
  ...
  txt <- c(txt, paste0("\t", "7) Locate your downloaded zip file (*.zip) container and use an extraction program to extract the folder's file contents. ",
