...
es5REF <- c("", "Formula: composite ~ dsex + b017451 + b003501 ", "", "Plausible values: 5", 
            "jrrIMax: 1", "Weight variable: 'origwt'", "Variance method: jackknife", 
            "JK replicates: 62", "full data n: 17606", "n used: 11220", "", 
            "", "Summary Table:",
            ...
            " Female             Multiple        I Don't Know   1   0.1435 100.00000000         NaN       NA        NA", 
...
wt1REF <- c("Wald test:", "----------", "H0: ", "b017451Once every few weeks = 0 ", 
            "b017451About once a week = 0 ", "b0174512 or 3 times a week = 0 ", 
            "b017451Every day = 0 ", "", "Chi-square test:", "X2 = 159.9, df = 4, P(> X2) = 0.0", 
            "", "F test:", "W = 38.0, df1 = 4, df2 = 59, P(> W) = 1.1e-15")

wt2REF <- c("Wald test:", "----------", "H0: ", "b017451Once every few weeks = 0 ", 
            "b017451About once a week = 0 ", "b0174512 or 3 times a week = 0 ", 
            "b017451Every day = 0 ", "", "Chi-square test:", "X2 = 185.8, df = 4, P(> X2) = 0.0", 
            "", "F test:", "W = 44.2, df1 = 4, df2 = 59, P(> W) = 0")
...
es_norhsREF <- c("", "Formula: composite ~ 1 ", "", "Plausible values: 5", "jrrIMax: 1", 
                 "Weight variable: 'origwt'", "Variance method: jackknife", "JK replicates: 62", 
                 "full data n: 17606", "n used: 16915", "", "",
                 "Summary Table:", 
                 "     N    WTD_N PCT     MEAN  SE(MEAN)",
                 " 16915 16932.46 100 275.8892 0.8217878")

dplO <- c("", "Formula: composite - geometry ~ avg_5", "", "jrrIMax: 1", 
          "Weight variable: 'origwt'", "Variance method: jackknife", "JK replicates: 62", 
          "full data n: 17606", "n used: 15144", "", "Coefficients:",
          "                   coef          se           t    dof  Pr(>|t|)    ", 
          "(Intercept) -32.1895692   1.7984639 -17.8983687 58.289 < 2.2e-16 ***", 
          "avg_5         0.1264752   0.0063834  19.8129915 53.390 < 2.2e-16 ***", 
          "---", "Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1", 
...
sPV_wREF <- c("Estimates are weighted using weight variable 'origwt'",
              ...
              "1 composite 16915   16932.46 126.110 251.9620 277.4799 275.8892 301.1861 404.184 36.57022    0            0",
              "2   algebra 16915   16932.46 109.842 254.7976 279.8315 278.9366 304.0191 412.152 36.65462    0            0")
...
sDiscrete_wREF <- c("Estimates are weighted using weight variable 'origwt'",
                    "                b017451   dsex Weighted N Weighted Percent Weighted Percent SE", 
                    "1  Never or hardly ever   Male       2350        2434.8441           61.603368", 
                    "2  Never or hardly ever Female       1487        1517.6088           38.396632", 
                    "3  Once every few weeks   Male       1603        1638.7454           51.356928", 
                    "4  Once every few weeks Female       1544        1552.1491           48.643072", 
                    "5     About once a week   Male       1384        1423.3119           48.449628", 
                    "6     About once a week Female       1469        1514.4029           51.550372", 
                    "7   2 or 3 times a week   Male       1535        1563.3931           45.634589", 
                    "8   2 or 3 times a week Female       1827        1862.5019           54.365411", 
                    "9             Every day   Male       1291        1332.8898           41.345206", 
                    "10            Every day Female       1841        1890.9176           58.654794", 
                    "11              Omitted   Male        316         111.8050           57.533222", 
                    "12              Omitted Female        259          82.5262           42.466778", 
                    "13             Multiple   Male          7           6.9849           94.805635", 
                    "14             Multiple Female          2           0.3827            5.194365")
...
cor_nocondenseREF <- c("Method: Pearson", "full data n: 17606", "n used: 14816", "", 
                       "Correlation: 0.1783484", "Correlation Levels:", "  Levels for Variable 'c046501' (Lowest level first):", 
                       "    1. 0%", "    2. 1-5%", "    3. 6-10%", "    4. 11-25%", 
                       "    5. 26-50%", "    8. Over 90%", "  Levels for Variable 'c044006' (Lowest level first):", 
                       "    1. None", "    2. 1-5%", "    3. 6-10%", "    4. 11-25%", 
                       "    5. 26-50%", "    6. 51-75%", "    7. 76-90%", "    8. Over 90%"
)

stdCoefREF <- c("                                  coef        se          t      dof     Pr(>|t|)     stdCoef       stdSE",
                "(Intercept)                 270.411121 1.0244340 263.961492 54.67002 0.000000e+00          NA          NA",
                "dsexFemale                   -2.958578 0.6042285  -4.896456 54.99112 8.947398e-06 -0.04070225 0.008412122",
                "b017451Once every few weeks   4.233414 1.1832671   3.577734 57.31606 7.131150e-04  0.04576213 0.012902260",
                "b017451About once a week     11.226123 1.2585369   8.919979 54.68320 2.983391e-12  0.11752133 0.013752712",
                "b0174512 or 3 times a week   14.945909 1.1866461  12.595085 72.58203 0.000000e+00  0.16594593 0.013147188",
                "b017451Every day              7.529984 1.3084558   5.754863 48.46975 5.755028e-07  0.08171641 0.014525542")
