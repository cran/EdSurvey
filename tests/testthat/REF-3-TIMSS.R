...
g2pREF <- c("gapList",
            ...
            "          50  554.1330    2.372200  544.5890    3.398268  9.543939 0.2109867 4.093114   0.02076780 189.38167", 
            "          90  637.3013    4.885717  624.3285    4.860274 12.972846 0.1195478 6.874110   0.06226954  92.47503")
...
pctREF <- c("Percentile",
            ...
            "          0   248.67 14.4169  0.0000           248.67           248.67    0.0", 
            "          1   345.74  6.0948  6.5838           323.94           359.33   81.8", 
            "         25   479.13  2.3386 25.2124           471.34           486.57 1995.0", 
            "         50   530.75  2.5736 24.6062           523.53           537.93 3926.0", 
            "         75   581.48  2.9514 28.7230           574.03           588.98 1958.6", 
            "         99   692.29  4.0554  4.1100           684.57           707.32   77.4", 
            "        100   781.63 18.7631  0.0000           781.63           781.63    0.0")
...
spv <-  c("There are 16 subject scale(s) or subscale(s) in this edsurvey.data.frame:", 
          ...
          "  The plausible value variables are: 'asmibm01', 'asmibm02', 'asmibm03', 'asmibm04', and 'asmibm05'", 
          "",
          "'sibm' subject scale or subscale with 5 plausible values.", 
          "  The plausible value variables are: 'assibm01', 'assibm02', 'assibm03', 'assibm04', and 'assibm05'", 
          "",
